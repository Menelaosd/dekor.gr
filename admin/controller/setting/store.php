...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['config_disable_cart'])) {
			$data['config_disable_cart'] = $this->request->post['config_disable_cart'];
		} elseif (isset($store_info['config_disable_cart'])) {
			$data['config_disable_cart'] = $store_info['config_disable_cart'];
		} else {
			$data['config_disable_cart'] = '';
		}
		
		if (isset($this->request->post['config_minorder'])) {
			$data['config_minorder'] = $this->request->post['config_minorder'];
		} elseif (isset($store_info['config_minorder'])) {
			$data['config_minorder'] = $store_info['config_minorder'];
		} else {
			$data['config_minorder'] = 50;
		}
