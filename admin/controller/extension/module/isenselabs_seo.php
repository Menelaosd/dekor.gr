...
class ControllerExtensionModuleiSenseLabsSeo extends Controller {
    ...
    public function tab_titles() {
        ...
        $product_title_string = json_decode($this->data['product_title_string'], true);
        if (!$product_title_string) {
            $product_title_string = array();
            foreach ($this->data['languages'] as $language) {
                $product_title_string[$language['language_id']] = $this->data['product_title_string'];
            }
        }
        $this->data['product_title_string'] = $product_title_string;

        $category_title_string = json_decode($this->data['category_title_string'], true);
        if (!$category_title_string) {
            $category_title_string = array();
            foreach ($this->data['languages'] as $language) {
                $category_title_string[$language['language_id']] = $this->data['category_title_string'];
            }
        }
        $this->data['category_title_string'] = $category_title_string;

        $information_title_string = json_decode($this->data['information_title_string'], true);
        if (!$information_title_string) {
            $information_title_string = array();
            foreach ($this->data['languages'] as $language) {
                $information_title_string[$language['language_id']] = $this->data['information_title_string'];
            }
        }
        $this->data['information_title_string'] = $information_title_string;

        $manufacturer_title_string = json_decode($this->data['manufacturer_title_string'], true);
        if (!$manufacturer_title_string) {
            $manufacturer_title_string = array();
            foreach ($this->data['languages'] as $language) {
                $manufacturer_title_string[$language['language_id']] = $this->data['manufacturer_title_string'];
            }
        }
        $this->data['manufacturer_title_string'] = $manufacturer_title_string;
    ...
    public function tab_image_titles() {
        ...
        $this->data['images_filename_product']     = $this->moduleModel->getSetting('images_filename_product', $this->storeId);
        $this->data['images_filename_product_additional'] = $this->moduleModel->getSetting('images_filename_product_additional', $this->storeId);
