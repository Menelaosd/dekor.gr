<?php
	class ControllerExtensionOnePageCheckout extends Controller {
		private $error = array();
		private $ssl = 'SSL';
		private $tpl = '.tpl';
	...
	public function index(){
		$this->load->language('extension/checkout/onepagecheckout');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('extension/onepagecheckout', 'user_token=' . $this->session->data['user_token'], $this->ssl));
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('checkout/onepagecheckout', 'user_token=' . $this->session->data['user_token'], $this->ssl)
		);

		$data['store_action'] =  $this->url->link('extension/onepagecheckout','user_token=' . $this->session->data['user_token'], $this->ssl);
		
		$data['action'] = $this->url->link('extension/onepagecheckout', 'user_token=' . $this->session->data['user_token'] . '&store_id='. $data['store_id'], $this->ssl);

		$data['cancel'] = $this->url->link('extension/extension', 'user_token=' . $this->session->data['user_token'], $this->ssl);
		
		$data['restoresetting'] = $this->url->link('extension/onepagecheckout/restoresetting', 'user_token=' . $this->session->data['user_token'].'&store_id='. $data['store_id'], $this->ssl);
		...
		$data['order_success'] =  $this->url->link('extension/order_success_page','&user_token='.$this->session->data['user_token']);
		
		
		if (isset($this->request->post['onepagecheckout_design_status'])) {
			$data['onepagecheckout_design_status'] = $this->request->post['onepagecheckout_design_status'];
		}else if(isset($store_info['onepagecheckout_design_status'])){
			$data['onepagecheckout_design_status'] = $store_info['onepagecheckout_design_status'];
		} else {
			$data['onepagecheckout_design_status'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_tab_background_color'])) {
			$data['onepagecheckout_tab_background_color'] = $this->request->post['onepagecheckout_tab_background_color'];
		}else if(isset($store_info['onepagecheckout_tab_background_color'])){
			$data['onepagecheckout_tab_background_color'] = $store_info['onepagecheckout_tab_background_color'];
		} else {
			$data['onepagecheckout_tab_background_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_tab_text_color'])) {
			$data['onepagecheckout_tab_text_color'] = $this->request->post['onepagecheckout_tab_text_color'];
		}else if(isset($store_info['onepagecheckout_tab_text_color'])){
			$data['onepagecheckout_tab_text_color'] = $store_info['onepagecheckout_tab_text_color'];
		} else {
			$data['onepagecheckout_tab_text_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_tab_active_background_color'])) {
			$data['onepagecheckout_tab_active_background_color'] = $this->request->post['onepagecheckout_tab_active_background_color'];
		}else if(isset($store_info['onepagecheckout_tab_active_background_color'])){
			$data['onepagecheckout_tab_active_background_color'] = $store_info['onepagecheckout_tab_active_background_color'];
		} else {
			$data['onepagecheckout_tab_active_background_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_tab_active_text_color'])) {
			$data['onepagecheckout_tab_active_text_color'] = $this->request->post['onepagecheckout_tab_active_text_color'];
		}else if(isset($store_info['onepagecheckout_tab_active_text_color'])){
			$data['onepagecheckout_tab_active_text_color'] = $store_info['onepagecheckout_tab_active_text_color'];
		} else {
			$data['onepagecheckout_tab_active_text_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_button_bg_color'])) {
			$data['onepagecheckout_button_bg_color'] = $this->request->post['onepagecheckout_button_bg_color'];
		}else if(isset($store_info['onepagecheckout_button_bg_color'])){
			$data['onepagecheckout_button_bg_color'] = $store_info['onepagecheckout_button_bg_color'];
		} else {
			$data['onepagecheckout_button_bg_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_button_color'])) {
			$data['onepagecheckout_button_color'] = $this->request->post['onepagecheckout_button_color'];
		}else if(isset($store_info['onepagecheckout_button_color'])){
			$data['onepagecheckout_button_color'] = $store_info['onepagecheckout_button_color'];
		} else {
			$data['onepagecheckout_button_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_block_heading_bgcolor'])) {
			$data['onepagecheckout_block_heading_bgcolor'] = $this->request->post['onepagecheckout_block_heading_bgcolor'];
		}else if(isset($store_info['onepagecheckout_block_heading_bgcolor'])){
			$data['onepagecheckout_block_heading_bgcolor'] = $store_info['onepagecheckout_block_heading_bgcolor'];
		} else {
			$data['onepagecheckout_block_heading_bgcolor'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_block_heading_color'])) {
			$data['onepagecheckout_block_heading_color'] = $this->request->post['onepagecheckout_block_heading_color'];
		}else if(isset($store_info['onepagecheckout_block_heading_color'])){
			$data['onepagecheckout_block_heading_color'] = $store_info['onepagecheckout_block_heading_color'];
		} else {
			$data['onepagecheckout_block_heading_color'] = '';
		}
		
		if (isset($this->request->post['onepagecheckout_custom_css'])) {
			$data['onepagecheckout_custom_css'] = $this->request->post['onepagecheckout_custom_css'];
		}else if(isset($store_info['onepagecheckout_custom_css'])){
			$data['onepagecheckout_custom_css'] = $store_info['onepagecheckout_custom_css'];
		} else {
			$data['onepagecheckout_custom_css'] = '';
		}
		...
		if($data['store_id']){
            ...
            if ($this->request->server['HTTPS']) {
                $server = ($store_infox['config_ssl'] ? $store_infox['config_ssl'] : HTTPS_CATALOG);
            } else {
                $server = ($store_infox['config_ssl'] ? $store_infox['config_ssl'] : HTTP_CATALOG);
            }
        }else{
            if ($this->request->server['HTTPS']) {
		...
		$data['callback'] = $server.'index.php?route=extension/onepagecheckout/social/facebook/';
		$data['googlecallback'] = $server.'index.php?route=extension/onepagecheckout/social/google/';
		...
		$data['customfeilds'] = $this->url->link('customer/custom_field','&user_token='.$this->session->data['user_token']);
		...
		$this->response->setOutput($this->load->view('extension/checkout/onepagecheckout', $data));
		
	}

	protected function validate(){
		if (!$this->user->hasPermission('modify', 'extension/onepagecheckout')) {
	...
	public function Restoresetting(){
		...
		if($this->validate()){
			...
			if(version_compare(VERSION,'2.1.0.1','>=')){
				$file = DIR_SYSTEM.'library/onepagechekout/onepagecheckout2x.sql';
			}else{
				if(version_compare(VERSION,'2.0.0.0','=')){
					$file = DIR_SYSTEM.'library/onepagechekout/onepagecheckout2.0.sql';
				}else{
					$file = DIR_SYSTEM.'library/onepagechekout/onepagecheckout2.0x.sql';
				}
			}
