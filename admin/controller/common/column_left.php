...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				$catalog[] = array(
					'name'	   => 'Τιμοκατάλογος DEKOR',
					'href'     => $this->url->link('catalog/product/pricelist', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}			
			...
			if ($this->user->hasPermission('access', 'catalog/product')) {
				$catalog[] = array(
					'name'	   => 'Τιμοκατάλογος APOKRIFA',
					'href'     => $this->url->link('catalog/product/pricelistApokrifa', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'extension/module/ho_newsletter')) {
				$marketing[] = array(
					'name'	   => 'Subscribers',
					'href'     => $this->url->link('extension/module/ho_newsletter/display', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'tool/automatisation')) {
				$maintenance[] = array(
					'name'	   => $this->language->get('text_automatisation'),
					'href'     => $this->url->link('tool/automatisation', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			
			if ($this->user->hasPermission('access', 'tool/xml_connect')) {
				$maintenance[] = array(
					'name'	   => $this->language->get('text_xml_connect'),
					'href'     => $this->url->link('tool/xml_connect', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
			...
			$data['menus'][] = array(
				'id'       => 'menu-seo-ultimate',
				'icon'	   => 'fa-bar-chart-o', 
				'name'	   => 'SEO Ultimate',
				'href'     => $this->url->link('extension/module/isenselabs_seo', 'user_token=' . $this->session->data['user_token'], true),
			);
