...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', sort_order = '" . (int)$data['sort_order'] . "', `show_label` = '" . (isset($data['show_label']) ? (int)$data['show_label'] : 0) . "'");
	...
	public function editOption($option_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', sort_order = '" . (int)$data['sort_order'] . "',`show_label` = '" . (isset($data['show_label']) ? (int)$data['show_label'] : 0) . "' WHERE option_id = '" . (int)$option_id . "'");
