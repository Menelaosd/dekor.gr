...
$_['text_on_edit_product'] = 'On add/ edit product:';
$_['text_generate_image_product'] = 'Automatically generate main image';
$_['text_generate_image_product_additional'] = 'Automatically generate additional image';
...
<p>It is possible to use a wildcard characters * (star/asterisk/multiplication symbol) in the Old URL Address to match incoming not found URLs. For example, "<b>software/*</b>" can match all 404 not found URL in software category URL: site.com/software/old-product, site.com/software/missing-product, etc</p>';
