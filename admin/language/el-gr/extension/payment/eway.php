...
$_['entry_test']                = 'Κατάσταση Δοκιμής';
...
$_['help_username']             = 'Το κλειδί του eWAY API από τον λογαριασμό σας στο MYeWAY (account).';
$_['help_password']             = 'Ο κωδικός του eWAY API από τον λογαριασμό σας στο MYeWAY (account).';
...
$_['text_card_message_V6014']   = 'Μη έγκυρο τιμολόγιο αναφοράς';
...
$_['text_card_message_V6031']   = 'Μη έγκυρος αριθμός κάρτα';
...
$_['text_card_message_V6037']   = 'Μη έγκυρος χρόνος';
...
$_['text_card_message_V6043']   = 'Απαιτείται το επίθετο του πελάτη';
...
$_['text_card_message_V6047']   = 'Απαιτείται η ανακατεύθυνσηURL';
$_['text_card_message_V6051']   = 'Μη έγκυρο όνομα';
$_['text_card_message_V6052']   = 'Μη έγκυρο επίθετο';
...
$_['text_card_message_V6067']   = 'Μη έγκυρο κράτος';
...
$_['text_card_message_V6076']   = 'Μη έγκυρο επίθετο διεύθυνσης αποστολής';
$_['text_card_message_V6077']   = 'Μη έγκυρη διεύθυνση 1 αποστολής';
$_['text_card_message_V6078']   = 'Μη έγκυρη διεύθυνση 2 αποστολής';
$_['text_card_message_V6079']   = 'Μη έγκυρη διεύθυνση πόλης';
$_['text_card_message_V6080']   = 'Μη έγκυρη διεύθυνση χώρας';
$_['text_card_message_V6081']   = 'Μη έγκυρη διεύθυνση Τ.Κ';
$_['text_card_message_V6082']   = 'Μη έγκυρη διεύθυνση Email';
$_['text_card_message_V6083']   = 'Μη έγκυρη διεύθυνση τηλεφώνου';
$_['text_card_message_V6084']   = 'Μη έγκυρη διεύθυνση Χώρας';
...
$_['text_card_message_V6102']   = 'Μη έγκυρος χρόνος λήξης της κάρτας';
...
$_['text_card_message_V6105']   = 'Μη έγκυρος αριθμός έκδοσης της κάρτας';
...
$_['text_card_message_V6112']   = 'Επιπλέον στοιχεία της κάρτας, εκτός από το χρόνο λήξης και μήνα';
$_['text_card_message_V6113']   = 'Μη έγκυρη συναλλαγή για επιστροφή';
$_['text_card_message_V6114']   = 'Σφάλμα επαλήθευσης Gateway';
$_['text_card_message_V6115']   = 'Μη έγκυρο αίτημα άμεσης επιστροφής χρημάτων, αριθμός(ID) συναλλαγής';
$_['text_card_message_V6116']   = 'Μη έγκυρα δεδομένα κάρτας στο αρχικό αναγνωριστικό συναλλαγής (TransactionID)';
$_['text_card_message_V6124']   = 'Μη έγκυρα στοιχεία. Τα στοιχεία έχουν δοθεί αλλά τα σύνολα δεν ταιριάζουν στο πεδίο συνολικό ποσό';
$_['text_card_message_V6125']   = 'Δεν έχει ενεργοποιηθεί ο επιλεγμένος τύπος πληρωμής';
$_['text_card_message_V6126']   = 'Λάθος κρυπτογραφησης του αριθμού της κάρτας, η αποκρυπτογράφηση απέτυχε';
...
$_['text_card_message_V6130']   = 'Μη έγκυρη γενική πληροφορία πελάτη';
$_['text_card_message_V6131']   = 'Μη έγκυρη γενική πληροφορία διεύθυνσης πελάτη';
