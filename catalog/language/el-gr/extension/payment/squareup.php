...
$_['text_trial']                        = '%s κάθε %s %s για %s πληρωμές στη συνέχεια ';
...
$_['text_cron_summary_token_heading']   = 'Ανανέωση του αναγνωριστικού πρόσβασης:';
$_['text_cron_summary_token_updated']   = 'Το αναγνωριστικό πρόσβασης έχει ενημερωθεί με επιτυχία!';
...
$_['text_token_revoked_subject']        = 'Το αναγνωριστικό πρόσβασης Square έχει ανακληθεί!';
$_['text_token_revoked_message']        = "Η πρόσβαση της επέκτασης πληρωμής Square στον Square λογαριασμό σας έχει ανακληθεί μέσω του Square Dashboard. Πρέπει να επαληθεύσετε τα στοιχεία πρόσβασης της επέκτασης σας στις ρυθμίσεις της επέκτασης και να συνδεθείτε ξανά.";
$_['text_token_expired_subject']        = 'Το αναγνωριστικό πρόσβασης στο Square έχει λήξει!';
$_['text_token_expired_message']        = "Το αναγνωριστικό πρόσβασης της επέκτασης πληρωμής  Square με το οποίο συνδέεται στον λογαριασμό σας στο Square έχει λήξει. Πρέπει να επαληθεύσετε τα στοιχεία σύνδεσης της επέκτασης σας και την εργασία CRON στις ρυθμίσεις της επέκτασης και να συνδεθείτε ξανά.";
...
$_['error_squareup_cron_token']         = 'Σφάλμα: Δεν ήταν δυνατή η ανανέωση του αναγνωριστικού πρόσβασης. Παρακαλώ συνδέστε την επέκταση πληρωμής Square μέσω του πίνακα διαχείρισης του OpenCart.';
...
// Statuses
$_['squareup_status_comment_authorized']    = 'συναλλαγή με κάρτα έχει εξουσιοδοτηθεί αλλά δεν έχει ακόμα δεσμευτεί.';
...
$_['squareup_override_error_phone_number']                  = 'Ο αριθμός τηλεφώνου πελάτη δεν είναι έγκυρος. Παρακαλώ τροποποιήστε την και δοκιμάστε ξανά.';
