	...
	public function callback() {
		...
		if ($order_info) {
			...
			if ((strcmp($response, 'VERIFIED') == 0 || strcmp($response, 'UNVERIFIED') == 0) && isset($this->request->post['payment_status'])) {
				...
				//$this->log->write($this->config->get('payment_pp_standard_pending_status_id'));
				$this->model_checkout_order->addOrderHistory($order_id, $this->config->get('payment_pp_standard_pending_status_id'));
			}
