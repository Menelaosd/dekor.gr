...
class ControllerExtensionOnepagecheckoutPersonalDetails extends Controller {
	...
	public function index(){
		...
		return $this->load->view('extension/onepagecheckout/personal_details', $data);
