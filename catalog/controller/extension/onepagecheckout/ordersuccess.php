<?php
class ControllerExtensionOnepagecheckoutOrderSuccess extends Controller {
	public function index(){
		...
		session_start();
		if(isset($_SESSION['temp_shipping_methods'])){
			unset($_SESSION['temp_shipping_methods']);
		}
		
		if(isset($_SESSION['temp_payment_methods'])){
			unset($_SESSION['temp_payment_methods']);
		}
		...
		if (isset($this->session->data['order_id'])) {
			...
			if($this->config->get('order_success_page_google_analytics')){
				$data['order_success_page_google_analytics'] = $this->config->get('order_success_page_google_analytics');
				$products = $this->cart->getProducts();
				$gaorder = $this->model_checkout_order->getOrder($this->session->data['order_id']);
				
				if($gaorder){
					$taxes = $this->model_extension_onepagecheckout_customer->getTax($this->session->data['order_id']);
					$shipping = $this->model_extension_onepagecheckout_customer->getShipping($this->session->data['order_id']);
					$data['currency_code'] = $gaorder['currency_code'];
					$data['addTrans'] = array(
						'order_id' 			=> $this->session->data['order_id'],
						'store_name' 		=> $gaorder['store_name'],
						'tax' 				=> (isset($taxes['value']) ? $taxes['value'] : ''),
						'total' 			=> $gaorder['total'],
						'shipping_price' 	=> isset($shipping['value']) ? $shipping['value'] : '',
						'payment_city' 		=> $gaorder['payment_city'],
						'payment_zone' 		=> $gaorder['payment_zone'],
						'payment_country' 	=> $gaorder['payment_country'],
					);
					
					$data['addItem'] = array();
					if($this->cart->getProducts()){
						foreach ($products as $product){
							$category = $this->model_extension_onepagecheckout_customer->getproductcategory($product['product_id']);
							$data['addItem'][] = array(
								'order_id' 		=> $this->session->data['order_id'],
			...
			unset($this->session->data['temp_payment_method']);
			unset($this->session->data['temp_shipping_method']);
		}
		...
		if($order_info){
			...
			if($this->config->get('order_success_page_print_invoice')){
				$data['print_invoice']= $this->url->link('extension/onepagecheckout/ordersuccess/printinvoice');
			}
			...
			$this->response->setOutput($this->load->view('extension/onepagecheckout/success', $data));
	...
	public function printinvoice(){
		if(isset($this->session->data['orderid'])){
			$order_id = $this->session->data['orderid'];
		}else{
			$order_id = 0;
		}
		...
		if($order_info){
				...
				$data['title'] = sprintf($this->language->get('text_subject'), $order_info['store_name'], $order_id);
				...
				$data['text_order_detail'] = ($this->config->get('order_success_page_order_details_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_order_details_heading'.$this->config->get('config_language_id')) : $this->language->get('text_new_order_detail'));
				$data['text_instruction'] = ($this->config->get('order_success_page_order_comment_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_order_comment_heading'.$this->config->get('config_language_id')) : $this->language->get('text_new_instruction'));
				...
				$data['text_payment_address'] = ($this->config->get('order_success_page_payment_address_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_payment_address_heading'.$this->config->get('config_language_id')) : $this->language->get('text_new_payment_address'));
				$data['text_shipping_address'] = ($this->config->get('order_success_page_shipping_address_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_shipping_address_heading'.$this->config->get('config_language_id')) : $this->language->get('text_new_shipping_address'));
				
				$data['text_bank_details'] = ($this->config->get('order_success_page_bank_details_heading'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_bank_details_heading'.$this->config->get('config_language_id')) : $this->language->get('text_new_bank_details'));
				
				$data['text_product'] = ($this->config->get('order_success_page_product_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_product_title'.$this->config->get('config_language_id')) : $this->language->get('text_new_product'));
				
				$data['text_model'] = ($this->config->get('order_success_page_model_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_model_title'.$this->config->get('config_language_id')) : $this->language->get('text_new_model'));
				...
				$data['text_quantity'] = ($this->config->get('order_success_page_qty_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_qty_title'.$this->config->get('config_language_id')) : $this->language->get('text_new_quantity'));
				
				$data['text_price'] = ($this->config->get('order_success_page_unit_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_unit_title'.$this->config->get('config_language_id')) : $this->language->get('text_new_price'));
				
				$data['text_total'] = ($this->config->get('order_success_page_total_title'.$this->config->get('config_language_id')) ? $this->config->get('order_success_page_total_title'.$this->config->get('config_language_id')) : $this->language->get('text_new_total'));
			  ...
			  $this->response->setOutput($this->load->view('extension/onepagecheckout/ordertemplate', $data));
	...
	public function CreateInvoice($order_id){
		...
		if($order_info){
				...
				$data['order_success_page_title_color'] = $this->config->get('order_success_page_title_color');
					...
					return $this->load->view('extension/onepagecheckout/ordertemplate', $data);
