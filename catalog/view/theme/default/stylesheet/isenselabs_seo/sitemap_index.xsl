		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="header">
					...
					<p>
						It contains a list of links to individual sitemaps. Each sitemap will be automatically followed by search engine bots and their contents indexed accordingly.
					</p>
				</div>
				<div id="content">
